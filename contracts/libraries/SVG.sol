...
library SVG {
    ...
    function _generateSVG(string memory body) internal pure returns (string memory) {
        ...
        string memory openingSVGTag = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 2400 2400" preserveAspectRatio="xMidYMin slice" style="stroke-width:0;background-color:#121212">';
