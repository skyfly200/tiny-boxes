    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method tokenPreview -n rinkeby --args "0, 16, 2, [222,80,70,30], [111,222,150,200], [0,255], [63,2,0,$ANIMATION,101], true, 100" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
