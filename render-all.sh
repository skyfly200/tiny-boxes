    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method tokenPreview -n rinkeby --args "0, 16,  2, [222,80,70,30], [111,222,150,200], [100,34], [7,7,5,7,$ANIMATION], true, 101" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
