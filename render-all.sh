    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method tokenPreview -n rinkeby --args "1111, [100,50,70], [30,5], [100,100,100,100], [50,50], 63, [50,10,1], [$ANIMATION,10,7,70], $SLOT" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
