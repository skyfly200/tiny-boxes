    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method perpetualRenderer -n rinkeby --args "[1111,100,50,70,30,5,100,100,100,100,75,50,63,132,10,1], $ID, $OWNER, [$ANIMATION,10,7,70], $SLOT" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
