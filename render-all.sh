    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method tokenPreview -n rinkeby --args "$ANIMATION, 16,  2, [222,80,70,30,6], [111,222,150,200], [100,34], [60,120,240,10], true" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
