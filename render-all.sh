    ...
    then
        ...
        if [ -z "$ALL" ]
            then
                ...
                # render svg at
                npx oz call --method tokenPreview -n rinkeby --args "0, 16,  2, [222,80,70,30], [111,222,150,200], [0,255], [7,7,5,7,$ANIMATION,101], true, 415" --to "$ADDRESS" > "./frames/Anim-$ANIMATION.svg"
            else
