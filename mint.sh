...
npx oz send-tx -n rinkeby -v --method createTo --to $ADDRESS --args "685525412542, 25, 5, [15,50,70], [100,100,100,100], [50,50], 63, 0x7A832c86002323a5de3a317b3281Eb88EC3b2C00, 0"
