    ...
    then 
        ...
        if [ -z "$ADDRESS" ]
            then
                ...
                for FRAME in {00..29}
                do
                    npx oz call --method tokenBulkTest -n rinkeby --args "12345, [10,10], [100,100,2,2,111,222,333,444,2,750,1200,2400,100], [true,true,true], $ANIMATION, $FRAME" --to "$ADDRESS">| "./frames/f$FRAME.svg"
