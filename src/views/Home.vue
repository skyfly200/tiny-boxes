    ...
    v-container(fluid)
      ...
      v-row.pb-6.section
        v-col(lg=4 md=6 cols=12 style="background-color: #444").pa-7
          .d-flex.flex-column.justify-space-between.on-chain(align="center")
            h1 Pioneering Art On-Chain
            h3 The first Animated On-Chain Generated NFT
            h3 SVGs generated by the NFT contract directly
            h3 Just read the chain, save and view
            h3 No code or render enviroment required!
            br
            .d-flex.justify-center.my-5
