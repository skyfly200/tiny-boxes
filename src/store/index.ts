...
const store = new Vuex.Store({
  ...
  state: {
    ...
    tinyboxesAddress: '0x1f1DF9cC0e4efB7bF7AB7Ec24A1cbcED9034d49B',
    openseaStoreURL: 'https://testnets.opensea.io/collection/tinyboxes-v49',
    openseaTokenURL: 'https://testnets.opensea.io/assets/0x1f1DF9cC0e4efB7bF7AB7Ec24A1cbcED9034d49B/',
    currentAccount: "",
    web3Status: "loading",
    web3: null,
    network: null,
