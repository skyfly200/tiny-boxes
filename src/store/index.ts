...
const store = new Vuex.Store({
  ...
  state: {
    ...
    tinyboxesAddress: '0xBBD8C1e6dFD3865806d09fcA5A6eE38bC625e646',
    openseaStoreURL: 'https://testnets.opensea.io/collection/tinyboxes-v49',
    openseaTokenURL: 'https://testnets.opensea.io/assets/0xBBD8C1e6dFD3865806d09fcA5A6eE38bC625e646/',
    currentAccount: "",
    web3Status: "loading",
    web3: null,
    network: null,
